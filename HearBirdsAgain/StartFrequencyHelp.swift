...
struct StartFrequencyHelp: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            Text("""
Use the *Start Frequency* control to select the frequency above which ***Hear Birds Again*** shifts sounds down in pitch. Note that the app filters out input sounds whose frequencies are below the start frequency, assuming that you will hear them directly. This works particularly well with the recommended open air [high-fidelity binaural headset](https://hearbirdsagain.org/high-fidelity-binaural-headset/). Note also that the frequency values indicated in the control have units of 1 kilohertz (abbreviated *kHz*), with 1 kilohertz being 1000 Hertz (abbreviated *Hz*).
