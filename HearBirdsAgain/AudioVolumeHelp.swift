...
If for typical settings of the iOS audio volume (e.g. ones appropriate for phone conversations or listening to music) the ourput of ***Hear Birds Again*** is too soft or too loud, try adjusting the gain setting on the app's *More Controls* tab. Note that if you use the recommended [binaural headset](https://hearbirdsagain.org/binaural-headset/), it is unlikely that you will need to do this.
